...
<head>
<meta charset="UTF-8">
<title>Edit Member - FitHealth</title>
                ...
                <div class="form-grid">
                    ...
                    <div>
                        ...
                        <select name="gender">
                            ...
                            <option value="Male"
                                <?= $m['gender'] == 'Male' ? 'selected' : '' ?>>
                                Male
                            </option>

                            <option value="Female"
                                <?= $m['gender'] == 'Female' ? 'selected' : '' ?>>
                                Female
                            </option>

                            <option value="Other"
                                <?= $m['gender'] == 'Other' ? 'selected' : '' ?>>
                                Other
                            </option>
                    ...
                    <div>
                        ...
                        <select name="membership_type">
                            ...
                            <option value="Regular"
                                <?= $m['membership_type'] == 'Regular' ? 'selected' : '' ?>>
                                Regular
                            </option>

                            <option value="Premium"
                                <?= $m['membership_type'] == 'Premium' ? 'selected' : '' ?>>
                                Premium
                            </option>

                            <option value="Student"
                                <?= $m['membership_type'] == 'Student' ? 'selected' : '' ?>>
                                Student
                            </option>
